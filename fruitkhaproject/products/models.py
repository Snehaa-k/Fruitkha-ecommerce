...
class Variant(models.Model):
    products = models.ForeignKey(
        Products, on_delete=models.CASCADE, related_name="variant"
    )
    unit_choices = [
        ("500g", "500 grams"),
        ("1kg", "1 kilogram"),
...
class Productoffer(models.Model):
    product_id = models.ForeignKey(
        Products, on_delete=models.CASCADE, null=True, related_name="offer"
    )
    variant_id = models.ForeignKey(
        Variant, on_delete=models.CASCADE, null=True, related_name="offerpv"
    )
...
class Categoryoffer(models.Model):
    category_id = models.ForeignKey(
        Category, on_delete=models.CASCADE, null=True, related_name="offer"
    )
    variant_i = models.ForeignKey(
        Variant, on_delete=models.CASCADE, null=True, related_name="offerv"
    )
    percentage = models.IntegerField()
    is_listed = models.BooleanField(default=False)
