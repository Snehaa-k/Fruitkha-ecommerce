...
urlpatterns = [
    path("admnlogin/", views.adlogin, name="admnlogin"),
    ...
    path(
        "order_moredetails/<str:id>", views.order_moredetails, name="order_moredetails"
    ),
    ...
    path(
        "editcategoryoffer/<str:id>", views.editcategoryoffer, name="editcategoryoffer"
    ),
    ...
    path(
        "delete_productoff/<str:id>", views.delete_productoff, name="delete_productoff"
    ),
